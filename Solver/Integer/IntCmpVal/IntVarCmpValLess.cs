...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntCmpVal/IntVarCmpValLess.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarCmpValLess.
	/// </summary>
	public class IntVarCmpValLess : IntVarCmpVal
	{
		public IntVarCmpValLess( IntVar var0, int val ) :
			base( var0, val )
		{
		}
