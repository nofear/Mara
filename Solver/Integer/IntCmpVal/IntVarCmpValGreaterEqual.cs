...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntCmpVal/IntVarCmpValGreaterEqual.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarCmpValGreaterEqual.
	/// </summary>
	public class IntVarCmpValGreaterEqual : IntVarCmpVal
	{
		public IntVarCmpValGreaterEqual( IntVar var0, int val ) :
			base( var0, val )
		{
		}
		...
		{
			Var0.Intersect( Value, int.MaxValue );
		}
	}
}
