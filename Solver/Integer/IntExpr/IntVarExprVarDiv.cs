...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntExpr/IntVarExprVarDiv.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarExprDiv.
	/// </summary>
	public class IntVarExprVarDiv : IntVarExprVar
	{	
		public IntVarExprVarDiv( IntVar var1, IntVar var2 ) :
			this( new IntVar( var1.Solver ), var1, var2 )
		{
		}

		public IntVarExprVarDiv( IntVar var0, IntVar var1, IntVar var2 ) :
			base( var0, var1, var2 )
		{
		}
