...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntExpr/IntVarExprVarAdd.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarExprAdd.
	/// </summary>
	public class IntVarExprVarAdd : IntVarExprVar
	{	
		public IntVarExprVarAdd( IntVar var1, IntVar var2 ) :
			this( new IntVar( var1.Solver ), var1, var2 )
		{
		}

		public IntVarExprVarAdd( IntVar var0, IntVar var1, IntVar var2 ) :
			base( var0, var1, var2 )
		{
		}
