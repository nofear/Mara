...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntExprVal/IntVarExprValAdd.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarExprValAdd.
	/// </summary>
	public class IntVarExprValAdd : IntVarExprVal
	{
		public IntVarExprValAdd( IntVar var1, int val ) :
			this( new IntVar( var1.Solver ), var1, val )
		{
		}

		public IntVarExprValAdd( IntVar var0, IntVar var1, int val ) :
			base( var0, var1, val )
		{
		}
