...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntExprVal/IntVarExprValSubRev.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarExprValSubRev.
	/// </summary>
	public class IntVarExprValSubRev : IntVarExprVal
	{	
		public IntVarExprValSubRev( int val, IntVar var1 ) :
			this( new IntVar( var1.Solver ), val, var1 )
		{
		}

		public IntVarExprValSubRev( IntVar var0, int val, IntVar var1 ) :
			base( var0, var1, val )
		{
		}
