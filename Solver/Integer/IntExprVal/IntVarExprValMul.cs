...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Integer/IntExprVal/IntVarExprValMul.cs $
 * 
...
{
	/// <summary>
	/// Summary description for IntVarExprValMul.
	/// </summary>
	public class IntVarExprValMul : IntVarExprVal
	{	
		public IntVarExprValMul( IntVar var1, int val ) :
			this( new IntVar( var1.Solver ), var1, val )
		{
		}

		public IntVarExprValMul( IntVar var0, IntVar var1, int val ) :
			base( var0, var1, val )
		{
		}
