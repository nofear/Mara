...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Float/FltExprVal/FltVarExprValSub.cs $
 * 
...
{
	/// <summary>
	/// Summary description for FltVarExprValSub.
	/// </summary>
	public class FltVarExprValSub : FltVarExprVal
	{	
		public FltVarExprValSub( FltVar var1, double val ) :
			this( new FltVar( var1.Solver ), var1, val )
		{
		}

		public FltVarExprValSub( FltVar var0, FltVar var1, double val ) :
			base( var0, var1, val )
		{
		}
