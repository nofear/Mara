...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Float/FltExprVal/FltVarExprValDiv.cs $
 * 
...
{
	/// <summary>
	/// Summary description for FltVarExprValDiv.
	/// </summary>
	public class FltVarExprValDiv : FltVarExprVal
	{	
		public FltVarExprValDiv( FltVar var1, double val ) :
			this( new FltVar( var1.Solver ), var1, val )
		{
		}

		public FltVarExprValDiv( FltVar var0, FltVar var1, double val ) :
			base( var0, var1, val )
		{
		}
