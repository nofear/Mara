...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Float/FltExprVal/FltVarExprValDivRev.cs $
 * 
...
{
	/// <summary>
	/// Summary description for FltVarExprValDivRev.
	/// </summary>
	public class FltVarExprValDivRev : FltVarExprVal
	{	
		public FltVarExprValDivRev( double val, FltVar var1 ) :
			this( new FltVar( var1.Solver ), val, var1 )
		{
		}

		public FltVarExprValDivRev( FltVar var0, double val, FltVar var1 ) :
			base( var0, var1, val )
		{
		}
