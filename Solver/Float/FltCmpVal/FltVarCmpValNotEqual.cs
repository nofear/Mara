...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Float/FltCmpVal/FltVarCmpValNotEqual.cs $
 * 
...
namespace MaraSolver.Float
{
	...
	/// </summary>
	public class FltVarCmpValNotEqual : FltVarCmpVal
	{
		...
		{
			return ( IsBound()
						&& !Epsilon.NotEqual( Var0.Value, m_Value ) );
		}

		public override void Update()
		{
			Var0.Difference( m_Value );
		}
	}
}
