...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Float/FltCmpVal/FltVarCmpValLessEqual.cs $
 * 
...
namespace MaraSolver.Float
{
	...
	/// </summary>
	public class FltVarCmpValLessEqual : FltVarCmpVal
	{
		public FltVarCmpValLessEqual( FltVar var0, double val ) :
			base( var0, val )
		{
		}
		...
		{
			return ( IsBound()
						&& !Epsilon.LessEqual( Var0.Value, m_Value ) );
		}
