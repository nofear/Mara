...
//--------------------------------------------------------------------------------
/* $Log: /Mara/Solver/Float/FltExpr/FltVarExprVarAdd.cs $
 * 
...
{
	/// <summary>
	/// Summary description for FltVarExprAdd.
	/// </summary>
	public class FltVarExprAdd : FltVarExprVar
	{	
		public FltVarExprAdd( FltVar var1, FltVar var2 ) :
			this( new FltVar( var1.Solver ), var1, var2 )
		{
		}

		public FltVarExprAdd( FltVar var0, FltVar var1, FltVar var2 ) :
			base( var0, var1, var2 )
		{
		}
